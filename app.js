...
function loguinDelJuego(){ //Se crea la funcion general de loguin del juego 

    let ingresoJuego = Number(prompt("por favor escoge la opcion: \n \n1. Ingresar al Juego \n     (Ingresar usario y Pass)\n2. Crear Usuario y Pass \n     (Crear nuevo usuario y contraseña)"))  //Se muestra el Usuario posibilidad de ingresar al juego mediante un Login o crear un nuevo usuario
    ...
    function crearNuevoUsuario(){     // Se crea la funcion para crear nuevo usuario.
            ...
            logicaDelJuego() // SE llama a la logica del juego
    ...
    if(ingresoJuego == 1){  // Si el Player elije opcion 1 entonces:
        ...
        if (datos.nomUsuario == UsuExistNomUsuario && datos.passUsuGuardado == UsuExistPassUsuario){// si ambos coinciden da ingreso llamando a la logica del juego.
            ...
            logicaDelJuego() // llama a la logica del juego
            break; // cuando se termina el juego sale con el break    
            }
    ...
    if (ingresoJuego == 2){ //En el caso que elija en la segunda opcion crear un usuario, se llama directamente a la funcion crearNuevoUsuario. 
        crearNuevoUsuario()
    }
}

loguinDelJuego() //Se llama a la funcion loguin para comenzar el mismo. 



/////////////////////////////////////////// DESDE AQUI ES LO MISMO QUE EL TRABAJO ANTERIOR OBLIGATORIO SOLO QUE ENCERRADO EN UNA FUNCION/////////////////////////////////////////////////////////////
...
function logicaDelJuego(){ //Se crea la logica del juego. donde se encuentra creada toda la logica del mismo. 
